import {AfterViewInit, Directive, ElementRef, HostBinding, Input, NgZone, OnDestroy, Optional, Renderer2} from '@angular/core';
...
export class CustomScrollbarDirective implements AfterViewInit, OnDestroy {
    ...
    /**
     * Update custm scrollbar when element content changes.
     */
